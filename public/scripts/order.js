$(document).ready(() => {
  $("[name=Customer]").on("change", () => {
    ...
    const foundCustomer = cusData.find(({ Name }) => Name === customer);
    $("#Terms").val(foundCustomer.Payment_Terms_Code);
    $("#Discount").val(foundCustomer.Invoice_Disc_Code);
    $("#Salesperson").val(foundCustomer.Salesperson_Code);
  });
